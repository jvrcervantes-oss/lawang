<?php
/**
 * v2 EXPLORATORIA de la landing de modelo — /modelo/v2/<id> (regla en .htaccess, junto a la 3).
...
<!-- v2 de prueba: noindex SIEMPRE, canonica a la ficha de verdad (duplicado de una pagina indexada). -->
...
<a class="villa reveal" href="/modelo/v2/<?= lw_e($ocId) ?>">
...
(function () {
  ...
  // v2 de prueba: SIN ViewContent a proposito (no contaminar las metricas de la campaña
  // que apunta a la ficha de verdad). track() se deja definida, sin llamarla.
  ...
  window.lwAuCfgInit({
    cfg: CFG,
    waNum: WA_NUM,
    urlBase: '/modelo/v2/<?= lw_e($m['id']) ?>',   // v2: el motor hace replaceState sobre esta ruta
    villaDefault: MODELO,
