<?php
/* ARCHIVADA 24-sep-2026 — versión v1 del deck genérico, guardada por si hay que
   restaurarla. El owner decidió ese día que la v3 (piel y composición de la home,
   la de investor-deck/palmfield/) es el diseño estándar de todos los investor-deck,
   y investor-deck/index.php pasó a llevarla. Esta copia se sirve en
