...
(function () {
  ...
  function topbarHTML(){
    ...
    return '<header id="topbar" class="show solid">'
      + '<div id="logo" class="dark"><a id="logo-inner" href="index.html" aria-label="Lawang — inicio"><img src="assets/img/lawang-logo-v3-dark.png" alt="Lawang Tropical Properties"></a></div>'
