...
/* LAW-247 en el documento IMPRESO (celda() dentro de tablaCuentaHTML) tiene su
   propio test en cuenta_marcador.test.js, que YA extraia esta misma funcion vía
   codigo_app.js -- una segunda extraccion aqui habria sido la MISMA trampa que
   codigo_app.js se escribio para cerrar (dos limites decidiendo lo mismo y
   pudiendo divergir). Hallazgo de code-review sobre el commit abdaa6cc. */
