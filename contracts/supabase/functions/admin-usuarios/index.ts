...
// que 'vencimientos': las tres herramientas intermedias (Vencimientos ya no, Modelos,
// Solicitudes) reutilizaron 'operaciones' porque esta edge estaba sin poder
// redesplegarse. Ésta no lo hace: abre datos de contacto de un centenar de personas y
// eso tiene que poder darse cuenta a cuenta.
