...
(function () {
  ...
  var EN = {
    ...
    'Por hoy no mando más avisos. Si es urgente, pídelo en el Asistente.': 'I won\'t send more reports today. If it\'s urgent, ask in the Assistant.',
    ...
    'Gracias. Queda avisado como SC-%n.': 'Thanks. Reported as SC-%n.',
    'Gracias. Queda avisado.': 'Thanks. It\'s been reported.',
    ...
    /* AxisWorks ERP · Ajustes → Impuestos y Productos (26-sep-2026). Solo se pintan con AXW_NUCLEO_OPERACION. */
    'Buscar por nombre, referencia o PRD-…': 'Search by name, reference or PRD-…',
    'Buscar producto': 'Search product',
    'Catálogo': 'Catalogue',
    'Desactivar': 'Deactivate',
    'Reactivar': 'Reactivate',
    'El catálogo de productos y servicios que se facturan por líneas, con su precio y su impuesto por defecto.': 'The catalogue of products and services invoiced line by line, with their price and default tax.',
    'El catálogo de productos y servicios que se facturan por líneas: nombre, referencia, precio por unidad y el impuesto que la línea trae puesto. Cada línea de factura guarda una copia del precio con el que salió, así que cambiar un producto no altera lo ya emitido.': 'The catalogue of products and services invoiced line by line: name, reference, unit price and the tax the line comes with. Each invoice line keeps a copy of the price it was issued with, so changing a product does not alter what has already been issued.',
    'España': 'Spain',
    'Indonesia': 'Indonesia',
    'Este módulo no está instalado en esta intranet.': 'This module is not installed in this intranet.',
    'Módulo no disponible': 'Module not available',
    'Exenta, no sujeta, inversión del sujeto pasivo y cualquier impuesto al 0 % llevan el motivo legal que se imprime en la factura. Solo puede haber uno por defecto en cada país y sociedad.': 'Exempt, not subject, reverse charge and any tax at 0 % carry the legal reason printed on the invoice. There can only be one default per country and company.',
    'Impuesto no encontrado': 'Tax not found',
    'Impuesto por defecto': 'Default tax',
    'Impuesto: no leído': 'Tax: not read',
    'Impuestos': 'Taxes',
    'Inversión del sujeto pasivo': 'Reverse charge',
    'Lo que se vende': 'What is sold',
    'Los impuestos que se pueden poner en una factura, por país. Cada factura guarda una copia del impuesto con el que salió: cambiar uno aquí no altera lo ya emitido. Uno que ya no se usa se desactiva, no se borra.': 'The taxes that can be put on an invoice, by country. Each invoice keeps a copy of the tax it was issued with: changing one here does not alter what has already been issued. One no longer in use is deactivated, not deleted.',
    'Motivo legal': 'Legal reason',
    'Nada coincide con la búsqueda.': 'Nothing matches the search.',
    'No hay ningún impuesto dado de alta.': 'No tax has been set up.',
    'No sujeta': 'Not subject',
    'Nuevo impuesto': 'New tax',
    'Nuevo producto': 'New product',
    'Por defecto': 'Default',
    'Producto': 'Product',
    'Productos': 'Products',
    'Sin impuesto por defecto': 'No default tax',
    'Solo': 'Only',
    'Suma': 'Adds',
    'Todavía no hay ningún producto en el catálogo.': 'There are no products in the catalogue yet.',
    'Trayendo el catálogo…': 'Loading the catalogue…',
    'Trayendo los impuestos…': 'Loading the taxes…',
    'Un producto no se borra: se desactiva y deja de ofrecerse al facturar. Darlo de alta o cambiarlo es de administración, y lo comprueba la base, no esta pantalla.': 'A product is not deleted: it is deactivated and stops being offered when invoicing. Creating or changing it is for administration, and the database checks it, not this screen.',
    'Volver al inicio': 'Back to home',
    'otro impuesto': 'another tax',
    'por': 'per',
