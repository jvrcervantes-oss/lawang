...
(function () {
  ...
  var EN = {
    ...
    'Solo lectura. Una cuenta nace apagada y no se enciende sin la fecha de la adenda firmada por el sales manager.': "Read-only. An account starts switched off and cannot be switched on without the date of the addendum signed by the sales manager.",
    ...
    'Adenda firmada': "Signed addendum",
    ...
    'Pon primero la fecha de la adenda firmada.': "Enter the signed addendum date first.",
    ...
    'Ninguna cuenta activa: actívala con la fecha de la adenda firmada.': "No active account: activate it with the signed addendum date.",
