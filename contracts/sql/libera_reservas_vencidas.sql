...
--
-- FIRMA (Desarrollo, para el botón manual "desistió"):
--   public.libera_reserva(p_unidad_id uuid, p_contrato_id uuid, p_motivo text,
--                          p_nota text default null) returns void
--   Llamada desde el panel: p_motivo := 'desistida', p_nota obligatoria.
--   Autenticado (authenticated) con sesión de admin/super_admin, o
--   sales_manager del proyecto de esa unidad. Un error se propaga como
--   excepción PostgREST normal (mensaje legible, sin código interno que
--   traducir en el front).
...
-- ════════════════════════════════════════════════════════════════════════════
-- SEGUNDA MIGRACIÓN (20260921060625) — arreglo tras get_advisors
-- ════════════════════════════════════════════════════════════════════════════
