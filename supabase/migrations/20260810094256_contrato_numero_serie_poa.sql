...
-- exhibit del Hak Sewa ante notario). Mismo patrón que las series ya existentes
-- (RP, CC, CG, CO, CR, CA, AC, PO, PB, C2, HS, CH): una secuencia propia y un
-- caso más en set_contrato_numero(). No toca ninguna fila existente.
