-- Serie propia para el PPJB de Bonian Beach — 4-ago-2026.
-- Serie aparte y no reutilizando RP a proposito: por el numero se sabe con que
-- texto se firmo una operacion, que es la misma razon por la que la Carta de
-- Reserva ampliada estreno la serie CA en vez de colarse en CR.
create sequence if not exists public.contratos_pb_seq;
