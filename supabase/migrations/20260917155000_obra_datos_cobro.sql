...
-- 'obra' hoy, y solo 4 son admin: no era hipotetico.
--
...
--
-- precio_total y moneda se leen de las COLUMNAS de `contratos` (numeric y text),
-- no de datos->fields: en el jsonb el precio es texto ya formateado ("76.500") y
-- Number() lo leeria como 76,5 -- tres ordenes de magnitud de error en una
-- pantalla que dispara cobros.
--
-- (Se aplico en dos pasos, 20260917155231 + 20260917155315: la primera version
--  devolvia precio_total como texto y hubo que recrearla para cambiar el tipo de
--  retorno, antes de que la usara ninguna pantalla.)
