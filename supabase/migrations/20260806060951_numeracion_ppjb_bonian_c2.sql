-- serie propia para el ejemplar estatico de PPJB Bonian Beach, Parcela C2:
-- prefijo C2 y secuencia propia para que su numero nunca choque con la serie
-- PB de la plantilla dinamica de PPJB Bonian (ppjb_bonian.html).
create sequence if not exists public.contratos_c2_seq;
