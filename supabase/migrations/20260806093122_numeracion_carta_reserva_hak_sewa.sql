-- serie propia para "Carta de Reserva (Hak Sewa)": prefijo CH, secuencia propia,
-- para no chocar con CR (carta_reserva) ni CA (carta_reserva_ampliada).
create sequence if not exists public.contratos_ch_seq;
