...
-- índice en `client_id` y clave primaria en `(contrato_id, rol)`). Comparado
-- resultado por resultado contra los 111 contratos reales: mismo conjunto o
-- más completo (7 casos donde el texto suelto se le escapaba una coincidencia
-- que el `client_id` ya resuelto sí encuentra — verificado en clients, son la
-- misma persona de verdad, no un falso positivo).
