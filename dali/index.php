...
h1{font-size:clamp(30px,4.4vw,52px);font-weight:700;text-transform:uppercase;letter-spacing:.005em}
...
.nav{position:sticky;top:0;z-index:60;background:var(--primary);
  border-bottom:1px solid var(--primary-cl);box-shadow:0 4px 20px rgba(16,76,79,.18)}
.nav__in{display:flex;align-items:center;justify-content:space-between;gap:16px;min-height:76px}
.nav__brand{height:34px;width:auto}
.nav__links{display:flex;align-items:center;gap:26px}
.nav__links a{font-family:var(--mono);font-size:11px;font-weight:500;color:rgba(255,255,255,.8);
...
@media(max-width:560px){
  .mosaico{grid-template-columns:minmax(0,1fr);grid-template-rows:none}
  .mosaico figure:first-child{grid-row:auto}
}
